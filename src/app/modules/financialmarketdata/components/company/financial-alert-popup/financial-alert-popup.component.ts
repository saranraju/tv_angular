...
@Component({
  selector: 'app-financial-alert-popup',
  templateUrl: './financial-alert-popup.component.html',
  styleUrls: ['./financial-alert-popup.component.scss'],
})
export class FinancialAlertPopupComponent implements OnInit {
  ...
  // yearlyfromPeriod: any = new Date('2015-03-31');
