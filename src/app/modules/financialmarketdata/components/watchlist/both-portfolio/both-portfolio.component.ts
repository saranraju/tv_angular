...
@Component({
  selector: 'app-both-portfolio',
  templateUrl: './both-portfolio.component.html',
  styleUrls: ['./both-portfolio.component.scss'],
})
export class BothPortfolioComponent implements OnInit {
  tableData: any = [];
